      ...
      .map(
        ...
        <li class="country-list__item">
          <a href="#" class="country-list__link" data-name="${country.name.official}">
            <img src="${country.flags.svg}"class="country-list__image" width="40" alt="flag ${country.name.official}" data-name="${country.name.official}">
...
function markupCountryCard({ languages, flags, name, capital, population }) {
    ...
    return `
      <div class="country-card">
        ...
        <p class="country-card__data"> Population: ${population}</p>
